...
it('should limit of total teams returned', () => {
  return pipe(
    app,
    TE.tryCatchK(
      app =>
...
it('should get error 404 when not found teams', () => {
  return pipe(
    app,
    TE.tryCatchK(
      app =>
...
it('should get ninjas from a teams', () => {
  return pipe(
    app,
    TE.tryCatchK(
      app =>
...
it('should get error 404 when not found ninjas from a teams', () => {
  return pipe(
    app,
    TE.tryCatchK(
      app =>
